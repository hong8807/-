document.addEventListener('DOMContentLoaded', () => {
    ...
    const messages = [
        "경증 증상 환자, LA GRADE A-B, 라비에트 10MG BID",
        "중증 질환 환자, LA GRADE C-D, 라비에트 20MG BID",
        "가슴 통증, 심한 속쓰림, 만성 기침, 쉰 목소리, 후두에 이물감이 있는 환자, 라비에트 20MG BID",
        "라비에트는 GERD에 대한 FULL DOSE BID 처방(20MG BID)되는 유일한 PPI입니다(K21.0)",
        "라비에트는 재활용 포장을 사용하는 친환경 제품입니다.",
        "라비에트는 가장 널리 사용되는 국내 라베프라졸 제품이므로 신뢰할 수 있습니다.",
        "클래리스로마이신과의 약물 상호 작용이 적어 라비에트 20MG BID는 제균요법에 효과적입니다."
    ];
    let messageIndex = 0;
